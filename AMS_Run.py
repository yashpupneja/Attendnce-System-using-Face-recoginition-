...
def manually_fill():
    global sb
    sb = tk.Tk()
    #sb.iconbitmap(os.path.join(sys.path[0], "/home/yashaswi/Desktop/FR/Attendace_management_system-master/AMS.ico"))
    sb.title("SUBJECT")
    sb.geometry('580x320')
    sb.configure(background='grey')
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry('300x100')
        #ec.iconbitmap(os.path.join(sys.path[0], "/home/yashaswi/Desktop/FR/Attendace_management_system-master/AMS.ico"))
        ec.title('Warning!!')
        ec.configure(background='grey')
        Label(ec, text='Please enter your subject name!!!', fg='red', bg='grey', font=('times', 16, ' bold ')).pack()
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            sb.destroy()
            MFW = tk.Tk()
            #MFW.iconphoto(True, PhotoImage(file="./AMS.png"))
            MFW.title("Manually attendance of "+ str(subb))
            MFW.geometry('880x470')
            MFW.configure(background='grey')
            ...
            def err_screen1():
                ...
                #errsc2.iconphoto(True, PhotoImage(file="./AMS.png"))
                errsc2.title('Warning!!')
                errsc2.configure(background='grey')
                Label(errsc2, text='Please enter Student & Enrollment!!!', fg='pnk', bg='white',
            ...
            global ENR_ENTRY
            ENR_ENTRY = tk.Entry(MFW, width=20,validate='key', bg="pink", fg="black", font=('times', 23, ' bold '))
            ...
            STUDENT_ENTRY = tk.Entry(MFW, width=20, bg="pink", fg="black", font=('times', 23, ' bold '))
            ...
            def create_csv():
                ...
                csv_name='/home/yashaswi/Desktop/FR/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="black", bg="orange", width=10,
                                     height=1,
                                     activebackground="Red", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="black", bg="orange", width=10,
                                      height=1,
                                      activebackground="Red", font=('times', 15, ' bold '))
            ...
            MAKE_CSV = tk.Button(MFW, text="Convert to CSV",command=create_csv, fg="black", bg="orange", width=20,
                                 height=2,
                                 activebackground="Red", font=('times', 15, ' bold '))
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"/home/yashaswi/Desktop/FR/Attendace_management_system-master/Attendance/Manually Attendance/-------Check atttendance-------"')

            attf = tk.Button(MFW,  text="Check Sheets",command=attf,fg="black"  ,bg="orange"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
            attf.place(x=730, y=410)

            MFW.mainloop()


    SUB = tk.Label(sb, text="Enter Subject", width=15, height=2, fg="black", bg="pink", font=('times', 15, ' bold '))
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="black", bg="orange", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    #sc1.iconphoto(True, PhotoImage(file="./AMS.png"))
    sc1.title('Warning!!')
    sc1.configure(background='grey')
    Label(sc1,text='Enrollment & Name required!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
    Button(sc1,text='OK',command=del_sc1,fg="black"  ,bg="orange"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def err_screen1():
    ...
    #sc2.iconphoto(True, PhotoImage(file="./AMS.png"))
    sc2.title('Warning!!')
    sc2.configure(background='grey')
    Label(sc2,text='Please enter your subject name!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
    Button(sc2,text='OK',command=del_sc2,fg="black"  ,bg="orange"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey')
                cs = '/home/yashaswi/Desktop/FR/Attendace_management_system-master/' + fileName
    ...
    windo = tk.Tk()
    #windo.iconphoto(True, PhotoImage(file="./AMS.png"))
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"/home/yashaswi/Desktop/FR/Attendace_management_system-master/Attendance-------Check atttendance-------"')
    ...
    sub = tk.Label(windo, text="Enter Subject", width=15, height=2, fg="black", bg="orange", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)
...
def admin_panel():
    win = tk.Tk()
    #win.iconphoto(True, PhotoImage(file="./AMS.png"))
    win.title("LogIn")
    ...
    def log_in():
        ...
        if username == 'yashaswi' :
            if password == 'yashaswi160':
                win.destroy()
                import csv
                import tkinter
                root = tkinter.Tk()
                ...
                cs = '/home/yashaswi/Desktop/FR/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    un = tk.Label(win, text="Enter username", width=15, height=2, fg="black", bg="orange",
                   font=('times', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="Enter password", width=15, height=2, fg="black", bg="orange",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
...
window.iconphoto(True, PhotoImage(file="./AMS.png"))
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", bg="red", fg="black", width=50,
...
txt = tk.Entry(window, validate="key", width=20, bg="pink", fg="black", font=('times', 25, ' bold '))
...
txt2 = tk.Entry(window, width=20, bg="pink", fg="black", font=('times', 25, ' bold '))
...
AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="black"  ,bg="lime green"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="orange"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="orange"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendace",fg="black",command=subjectchoose  ,bg="orange"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="orange"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
